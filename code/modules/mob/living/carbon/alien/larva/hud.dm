...
*/
	...
	mymob.client.screen += list( mymob.zone_sel, mymob.oxygen, mymob.toxin, mymob.fire, mymob.healths, mymob.pullin, mymob.flash)//, mymob.blind //, mymob.rest, mymob.sleep, mymob.mach )
