...
/obj/item/weapon/cable_coil/random/New()
	colored = pick("red","yellow","green","blue","pink")
	icon_state = "coil_[colored]"
	..()
...
/obj/item/weapon/flavor
	...
	colored = "beige" //Color the icon should take on when this is applied.  Also shown when it is mixed in.
