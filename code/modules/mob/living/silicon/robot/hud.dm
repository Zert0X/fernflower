...
//Temp
	...
	*/
	...
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.oxygen, mymob.fire, mymob.hands, mymob.healths, mymob:cells, mymob.pullin, mymob.flash)//, mymob.blind //, mymob.rest, mymob.sleep, mymob.mach )
