/mob/verb/traitorstats()
	...
	if(istype(usr,/mob))
		...
		if(istype(infos))
			...
			show_browser(M, text("<HEAD><TITLE>Traitor statistics</TITLE></HEAD><BODY bgcolor='#100000' text='white'><TT><strong>[]</strong></TT></BODY>", dat), "window=trait_rec;size=500x320")
		else
