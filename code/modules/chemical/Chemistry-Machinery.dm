...
/obj/machinery/chem_dispenser/
	...
	var/amount = 30
	var/beaker = null
	var/list/dispensable_reagents = list("hydrogen","lithium","plasma","carbon","nitrogen","oxygen","fluorine","sodium","aluminum","silicon","phosphorus","sulfur","chlorine","potassium","iron","copper","mercury","radium","water","ethanol","sugar","acid","milk",)
...
/obj/machinery/chem_master/
	...
	Topic(href, href_list)
		...
		if (href_list["analyze"])
			...
			var/name = sanitize(input(usr,"Name:","Name your pill!",reagents.get_master_reagent_name()))
			...
			if(!condi)
				var/name = sanitize(input(usr,"Name:","Name your bottle!",reagents.get_master_reagent_name()))
...
/obj/machinery/computer/pandemic
	...
	Topic(href, href_list)
		...
		if (href_list["create_vaccine"])
			...
			show_browser(usr, null, "window=pandemic")
			src.updateUsrDialog()
			return
...
/obj/machinery/reagentgrinder
	...
	var/global/list/allowed_items = list ( // reagent = amount, amount of 0 indicate to determine the amount from the reagents list, only implemented on plants for now
		...
		/obj/item/weapon/reagent_containers/food/snacks/grown/banana = list("banana" = 20),
		/obj/item/weapon/reagent_containers/food/snacks/grown/carrot = list("imidazoline" = 20),
		/obj/item/weapon/reagent_containers/food/snacks/grown/corn = list("cornoil" = 10),
		/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/libertycap = list("psilocybin" = 10),
		/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/amanita = list("amatoxin" = 15, "psilocybin" = 15),
		/obj/item/weapon/reagent_containers/food/snacks/grown/mushroom/angel = list("amatoxin" = 40, "psilocybin" = 20),
		/obj/item/weapon/reagent_containers/food/snacks/grown/chili = list("capsaicin" = 10),
		/obj/item/weapon/reagent_containers/food/snacks/grown/icepepper = list("frostoil" = 10),
...
"}
	...
	show_browser(user, "<HEAD><TITLE>Reagent Grinder</TITLE></HEAD><TT>[dat]</TT>", "window=reagentgrinder")
